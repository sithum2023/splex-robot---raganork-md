...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || '༺ֆքʟɛӼ ʀօɮօȶ༻;Skl11;0;https://www.linkpicture.com/q/splex-robot.png;https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBIHb',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "༺ֆքʟɛӼ ʀօɮօȶ༻",
    BOT_NAME: process.env.BOT_NAME || '༺ֆքʟɛӼ ʀօɮօȶ༻',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? '★彡[ᴍʀ. ꜱɪᴛʜᴜᴍ]彡★;༺ֆքʟɛӼ ʀօɮօȶ༻ bot;https://www.linkpicture.com/q/splex-robot.png' : process.env.AUDIO_DATA,
